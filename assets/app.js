...
(()=>{
  ...
  style.textContent=`
    .siteMenuToggle{border:1px solid var(--gold,#d79a18);background:#0b0b0b;color:#f5f3ed;padding:10px 14px;border-radius:2px;font-weight:900;cursor:pointer;white-space:nowrap}
    ...
    .budgetFloat{position:fixed;right:18px;bottom:78px;z-index:80;background:var(--gold,#d79a18);color:#111;border:1px solid var(--gold,#d79a18);border-radius:999px;padding:12px 17px;font-weight:900;box-shadow:0 8px 30px #0008}
    @media(min-width:801px){.siteMenuToggle,.siteMenuPanel{display:none!important}}
    @media(max-width:800px){.siteMenuPanel{top:74px}.budgetFloat{right:18px;bottom:76px}}
  `;
